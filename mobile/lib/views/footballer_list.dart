...
class FootballerListPage extends StatefulWidget {
  const FootballerListPage({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => FootballerListPageState();
}

class FootballerListPageState extends State {
  int touchedIndex = -1;
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    RaisedButton(
                      ...
                      onPressed: () {
                        Navigator.pushNamed(context, route.footballerAddPage);
                      },
                    ),
                    RaisedButton(
                      color: Colors.blueAccent,
                    ...
                    RaisedButton(
                      ...
                      onPressed: () {
                        Navigator.pushNamed(
                            context, route.footballerUpdatePage);
                      },
                    )
                  ],
                ))
